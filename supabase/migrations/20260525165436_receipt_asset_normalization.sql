...
VALUES
  ('receipts-original', 'receipts-original', false, 15728640, ARRAY['image/jpeg','image/jpg','image/png','image/webp','image/heic','image/heif','application/pdf']),
  ('receipts-optimized', 'receipts-optimized', false, 10485760, ARRAY['image/jpeg','image/jpg']),
  ('receipts-thumbnails', 'receipts-thumbnails', false, 2097152, ARRAY['image/jpeg','image/jpg']),
  ('receipts-debug', 'receipts-debug', false, 10485760, ARRAY['image/jpeg','image/jpg','image/png','application/json'])
...
CREATE POLICY admin_storage_all ON storage.objects
  ...
  USING (bucket_id = ANY (ARRAY['receipts','receipts-optimized','receipts-original','receipts-thumbnails','receipts-debug','job-media','cms-media','media-library','lead-media','signed-documents']))
  WITH CHECK (bucket_id = ANY (ARRAY['receipts','receipts-optimized','receipts-original','receipts-thumbnails','receipts-debug','job-media','cms-media','media-library','lead-media','signed-documents']));
