...
export function TransformationShowcase({
  ...
  return (
    <section className="transformation-proof-band relative py-16 md:py-24">
      ...
      <ScrollRevealStagger className="relative mt-12 grid gap-10 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] lg:items-start lg:gap-14">
        <ScrollRevealItem>
        ...
        <ScrollRevealItem>
          <div className="flex flex-col justify-center lg:py-4">
            ...
            <h3 className="mt-3 text-xl font-semibold tracking-tight text-navy md:text-2xl">
              {featured.title}
            </h3>
            <p className="mt-1 text-sm text-charcoal/60">{featured.location}</p>
            <p className="mt-5 text-sm leading-relaxed text-charcoal/75 md:text-base">
              {featured.summary}
            </p>
